...
public class UserMetaData implements Serializable {
	...
	public UserMetaData(String nickName, String passWord, String apyn, String mail, String tel, Date fechaAlta,
	...
	public String toString() {
		return "UserMetaData [user=" + user + ", password=" + password + ", apyn=" + apyn + ", mail=" + mail
				+ ", telefono=" + telefono + ", fechaAlta=" + fechaAlta + ", fechaNacimiento=" + fechaNacimiento
				+ ", conectado=" + conectado + "]";
	}
